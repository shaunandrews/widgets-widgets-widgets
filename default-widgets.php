...
class WP_Widget_Pages extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('pages', __('List of Pages'), $widget_ops);
	}
...
class WP_Widget_Search extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('search', __('Search Box'), $widget_ops);
	}
...
class WP_Widget_Archives extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('archives', __('Monthly Post Archives'), $widget_ops);
	}
...
class WP_Widget_Meta extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('meta', __('Login Links'), $widget_ops);
	}
...
class WP_Widget_Calendar extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('calendar', __('Post Calendar'), $widget_ops);
	}
...
class WP_Widget_Text extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('text', __('Text/HTML Box'), $widget_ops, $control_ops);
	}
...
class WP_Widget_Categories extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('categories', __('Categories List'), $widget_ops);
	}
...
class WP_Widget_RSS extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'rss', __('RSS Feed'), $widget_ops, $control_ops );
	}
